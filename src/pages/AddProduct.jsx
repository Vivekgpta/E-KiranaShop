...
const AddProduct = () => {
  ...
  return (
    <div className="container mt-12 bg-amber-300">
      <div className="center-container bg-blue-300 ">
        <form className= {`row pt-40 bg-amber-700 g-3 px-6 pb-4 ${
          open
            ? "opacity-100 scale-100"
            : "opacity-0 scale-95 pointer-events-none"
        }`} onSubmit={submitHandler}>
          <div className="col-md-6 bg-green-300">
